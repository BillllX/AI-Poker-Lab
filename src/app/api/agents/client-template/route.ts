...
For raise, amount is the extra chips added on top of the currentBet, not the target total bet. It should be at least minRaise unless intentionally going all-in for less.
