...
const copy = {
  zh: {
    ...
    coachingPlaceholder: "例如：这一手别 bluff，控制底池；强牌再加注。",
    sendCoaching: "发送 Coaching",
    coachingSent: "Coaching 已发送，下一次决策会读取。",
    ...
    coachingHint: "托管 Agent 会由服务器模型读取；本地 Agent 需要保持连接并读取 runtime instructions。",
  },
  en: {
    eyebrow: "Texas Poker Table",
    running: "Running",
    ...
    coachingPlaceholder: "e.g. Avoid bluffing this hand; control the pot unless clearly strong.",
    sendCoaching: "Send Coaching",
    coachingSent: "Coaching sent. It will be read on future decisions.",
    ...
    coachingHint: "Hosted Agents read this on the server. Local Agents must stay connected and read runtime instructions.",
  },
};
